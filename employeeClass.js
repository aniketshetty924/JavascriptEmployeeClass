...
let employee1 = Employee.newEmployee(
  "Aniket",
  "Shetty",
  "02/06/2003",
  40000,
...
let employee2 = Employee.newEmployee(
  "Aneesh",
  "Kumar",
  "01/13/2003",
  40000,
...
let employee3 = Employee.newEmployee(
  "Rajesh",
  "Kumar",
  "12/28/2003",
  35000,
...
console.log(
  `Employee Name : ${employee1.getFullName()}     Employee ID : ${employee1.getEmployeeID()}`
);
console.log(
  `Employee Name : ${employee2.getFullName()}     Employee ID : ${employee2.getEmployeeID()}`
);
console.log(
  `Employee Name : ${employee3.getFullName()}     Employee ID : ${employee3.getEmployeeID()}`
);

console.log(Employee.updateEmployeeByID(2, "firstName", "Karthik"));
console.log(
  `Employee Name : ${employee3.getFullName()}     Employee ID : ${employee3.getEmployeeID()}`
);
